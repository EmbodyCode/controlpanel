...
class News extends \AppBundle\Entity\News implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'author', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'text', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'picture'];
        }
