...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'app.login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\LoginListener A AppBundle\EventListener\LoginListener instance
     */
    protected function getApp_LoginService()
    {
        return $this->services['app.login'] = new \AppBundle\EventListener\LoginListener($this);
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('app.login', 'AppBundle\\EventListener\\LoginListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'embodyco_symf2', 'user' => 'embodyco_symf2', 'password' => 'R&o~k6asSMpf@SeJ&x~20(@9', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_402f7db07cf0abe804a373e4d4b49fd7f45f8296464dc1a2ebc2c3a7f2e424a3');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/registration');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('630eb6a68fab4f6a96f1ab1854558549');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'embodyco_symf2',
            'database_user' => 'embodyco_symf2',
            'database_password' => 'R&o~k6asSMpf@SeJ&x~20(@9',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '630eb6a68fab4f6a96f1ab1854558549',
            'locale' => 'en',
            ...
            'kernel.secret' => '630eb6a68fab4f6a96f1ab1854558549',
